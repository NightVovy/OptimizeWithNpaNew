...
# 定义5个向量
T1 = [ # sintheta00 - costheta11
    -sp.sin(a0 - 2 * theta)/2 + sp.sin(a0 + 2 * theta)/2,
    -sp.sin(a1 - 2 * theta)/2 + sp.sin(a1 + 2 * theta)/2,
    -sp.sin(b0 - 2 * theta)/2 + sp.sin(b0 + 2 * theta)/2,
    -sp.sin(b1 - 2 * theta)/2 + sp.sin(b1 + 2 * theta)/2,
