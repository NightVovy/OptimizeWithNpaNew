...
def calculate_and_verify(theta):
    ...
    return method1, method3, expr1_method1, expr1_method3, expr2, alpha, a0, a1, b0, b1


# Calculate with new measurement settings
method1, method3, expr1_m1, expr1_m3, expr2, alpha, a0, a1, b0, b1 = calculate_and_verify(theta)

# Print the values of theta, a0, a1, b0, b1
print("Parameter values:")
print(f"theta = {theta:.8f} radians ({np.degrees(theta):.8f} degrees)")
print(f"a0 = {a0:.8f} radians ({np.degrees(a0):.8f} degrees)")
print(f"a1 = {a1:.8f} radians ({np.degrees(a1):.8f} degrees)")
print(f"b0 = {b0:.8f} radians ({np.degrees(b0):.8f} degrees)")
print(f"b1 = {b1:.8f} radians ({np.degrees(b1):.8f} degrees)")
print()
