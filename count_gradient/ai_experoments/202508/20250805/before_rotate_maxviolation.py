...
def calculate_and_verify(theta):
    ...
    expr1_method3 = alpha * B0 + E10 + E00 + E11 - E01

    expr2 = np.sqrt(8 + 2 * alpha ** 2)

    return method1, method2, expr1_method1, expr1_method2, expr1_method3, expr2, alpha


# Calculate with new measurement settings
method1, method2, expr1_m1, expr1_m2, expr1_m3, expr2, alpha = calculate_and_verify(theta)
