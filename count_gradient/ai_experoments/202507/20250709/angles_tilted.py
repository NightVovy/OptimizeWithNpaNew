...
# 定义角度（单位：弧度）
theta = np.pi / 6  # psi 的参数
a0 = 0
a1 = np.pi / 2
b0 = np.arctan(np.sin(2 * theta))
b1 = np.pi - b0
...
# 打印结果
print(f"a0 = {a0:.6f} rad = {rad2deg(a0):.2f}°")
print(f"a1 = {a1:.6f} rad = {rad2deg(a1):.2f}°")
print(f"b0 = {b0:.6f} rad = {rad2deg(b0):.2f}°")
print(f"b1 = {b1:.6f} rad = {rad2deg(b1):.2f}°\n")
