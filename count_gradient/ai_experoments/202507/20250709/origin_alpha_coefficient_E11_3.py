...
if __name__ == "__main__":
    ...
    print("\n新bell表达式的组合矩阵的最大特征值:")
    print(f"{max_eigenvalue:.8f}")

    # 计算并输出代入期望值的新bell表达式的值
    bell_value = (terms[0] * EA0 + terms[1] * EA1 + terms[2] * EB0 + terms[3] * EB1 +
                  terms[4] * EA0B0 + terms[5] * EA0B1 + terms[6] * EA1B0 + terms[7] * EA1B1)
    print(f"\n代入期望值的新bell表达式的值为: {bell_value:.8f}")