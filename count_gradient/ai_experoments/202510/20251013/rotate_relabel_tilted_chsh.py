...
def calculate_and_verify(theta):
    ...
    # 创建P数组，包含8个值：A0_r, A1_r, B0_r, B1_r, E00_r, E01_r, E10_r, E11_r
    P = [A0_r, A1_r, B0_r, B1_r, E00_r, E01_r, E10_r, E11_r]

    return method1, method3, expr1_method1, expr1_method2, expr1_method3, expr2, alpha, P


# Calculate with new measurement settings
method1, method3, expr1_m1, expr1_m2, expr1_m3, expr2, alpha, P = calculate_and_verify(theta)
...
print(f"  Method 1 原alpha不等式: {expr1_m1:.8f}")
print(f"  Method 2 重新标记后的不等式: {expr1_m2:.8f}")
print(f"  Method 3 均用旋转后的态+期望+kron: {expr1_m3:.8f}")
...
print(f"B0_r = {P[2]:.8f}")
print(f"B1_r = {P[3]:.8f}")
print(f"E00_r = {P[4]:.8f}")
print(f"E01_r = {P[5]:.8f}")
print(f"E10_r = {P[6]:.8f}")
print(f"E11_r = {P[7]:.8f}")
