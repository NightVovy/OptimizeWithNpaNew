...
def build_fidelity_objective(G, ind_catalog, m_vec, theta):
    ...
    term_E0_F0F2F0 = get_term([idx_A0], [idx_B0, idx_B2, idx_B0])
    ...
    func = part_1 + part_2 + part_3 + part_4 + part_5
    ...
    debug_dict = {
        ...
        # --- Part 2 (Alice 3体混合) ---
        "d_A1B0": d_A1B0,
        "d_A0A1A0B0": d_A0A1A0B0,

        # --- Part 3 (Bob 3体混合) ---
        "d_B2": d_B2,
        "d_B0B2B0": d_B0B2B0,
        "d_A0B2": d_A0B2,
        "d_A0B0B2B0": d_A0B0B2B0,

        # --- Part 4 (X 轴主关联 & 反对易) ---
        "d_A1B2": d_A1B2,
        "d_A1B0B2B0": d_A1B0B2B0,
        "d_A0A1A0B2": d_A0A1A0B2,
        "d_A0A1A0B0B2B0": d_A0A1A0B0B2B0,  # 6体核心项

        # --- Part 5 (4体交叉项) ---
        "d_A0A1B0B2": d_A0A1B0B2,
        "d_A0A1B2B0": d_A0A1B2B0,
        "d_A1A0B0B2": d_A1A0B0B2,
        "d_A1A0B2B0": d_A1A0B2B0
    }

    return func, part_1, part_2, part_3, part_4, part_5, debug_dict
